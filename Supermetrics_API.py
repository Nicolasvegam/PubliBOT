...
#text = requests.get('https://www.googleapis.com/analytics/v3/data/ga?ids=ga%3A79575411&containsSampledData=false&start-date=2019-06-01&end-date=2019-06-28&metrics=ga%3Apageviews&dimensions=ga%3ApagePath%2Cga%3AuserGender&filters=ga%3ApagePath%3D%40Lippi&samplingLevel=faster&access_token=ya29.Gls8B8VtCUmTteNZfoPFnZb98foy4l-wguIlRPoqVR0gq17LfWZoNpKmOZIQniXbejG3YaT1YdMoZdYeNVIywFANGa7cBWoLy-HobIujNd0gdM6KFRWGdgfuN0sQ')
#data = json.loads(text.text)
#print(data)
...
#}
#
#text = requests.post('https://analyticsreporting.googleapis.com/v4/reports:batchGet', data = body )
#data = json.loads(text.text)
#print(data)
#
#seller = "Somela"
#
#admanager_query = 'https://supermetrics.com/api/v1/#getData?metrics=TOTAL_INVENTORY_LEVEL_CLICKS%2CTOTAL_INVENTORY_LEVEL_CTR_perc%2CTOTAL_INVENTORY_LEVEL_IMPRESSIONS&dimensions=LINE_ITEM_NAME&filters=ORDER_NAME%3D%40MLC%3BORDER_NAME%3D%40{0}&maxResults=1000&dateRangeType=thisyear&profiles=%5B%7B%22ID%22%3A%22105773011%22%2C%22name%22%3A%22Mercado%20Libre%22%7D%5D&otherParams=%5B%5D&dataSource=DFP&dsUser=ext_nicovega%40mercadolibre.com&apiKey=api_g29hM3MCYvfUeQcaTBm8nXfi4PZXN5VsySTzJfUtICgo0ogcNC4ljb5A7ECHwubTLdGw6bgKR7j3cge0pAbn09PWZTDdLKtGihVG'.#format(seller)
#
